...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      `Contact ${agencyName} at ${locationName} for all your insurance needs.`,
...
export default async function LocationContactPage({ params }: PageProps) {
  ...
  const smsMessage =
    location?.sms_default_message ||
    websiteData?.sms_default_message ||
    "Hi! I'd like to get an insurance quote. Please contact me.";
  ...
  const mapQuery = mapAddressParts.length
  ...
  return (
    <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 max-w-screen-xl text-center">
            <div className="bg-card-bg rounded-xl p-8 max-w-2xl mx-auto shadow-md border border-card-border">
              ...
              <p className="text-theme-body text-lg mb-6">
                For the fastest service, text us your insurance questions.
                We&apos;ll respond quickly with personalized quotes and answers.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                ...
                <span className="text-theme-body font-medium">
      ...
      <section className="py-16 bg-[#eae0d5] relative">
              ...
              <div className="space-y-10">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-theme-body text-xl font-medium">
                      {formattedPhone || ""}
                    </p>
                  </div>
                </div>
                        ...
                        {[
                          ...
                          return (
                            <React.Fragment key={day}>
                              <p className="text-theme-body font-medium capitalize">
                                {day}:
                              </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateLdJsonSchema(clientData, websiteData, websiteData)
          ),
        }}
      />
    </main>
