      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <p className="text-lg text-gray-600">
            We are not accepting applications at this time. Please check back
            later.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-secondary mb-6">
              We&apos;d love to hear from you! Feel free to reach out if you
              have any questions about career opportunities at {locationName}.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center justify-center bg-white hover:bg-gray-50 text-primary font-bold py-3 px-8 rounded-full border-2 border-[var(--divider-color)] transition duration-300"
              >
                Contact Us
              </a>
            </div>
