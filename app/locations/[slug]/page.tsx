...
async function getLocationPageData(
  ...
  const { data, error } = await supabase
    ...
    .select(
      "hero_section, intro_section, services_section, faq_section, careers_section, cta_section, meta_title, meta_description"
    )
...
export default async function LocationLandingPage({ params }: PageProps) {
  ...
  const heroSubheading =
    pageData?.hero_section?.subheading ||
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4">
          <div className="w-full max-w-5xl mx-auto text-center animate-fade-in">
            ...
            <h2
              className="inline-block text-secondary sm:text-lg md:text-xl lg:text-2xl font-medium px-4 py-2 sm:px-6 sm:py-3 bg-white/40 backdrop-blur-sm rounded-xl shadow-md tracking-wide max-w-2xl"
      ...
      {(introSection?.heading ||
        ...
        <section className="py-20 bg-[#f5f5f5] relative w-full">
          <div className="container mx-auto px-4 py-4 max-w-screen-2xl">
            ...
            >
              ...
              {introSection?.imageUrl && (
                <div
                  className={`relative rounded-2xl overflow-hidden shadow-lg ${getAspectRatioClasses(introAspectRatio)} animate-fade-in-right`}
                >
                  <Image
                  ...
                  {introSection?.imageTag && (
                    <div className="absolute bottom-4 left-4 md:bottom-6 md:left-6 lg:bottom-8 lg:left-8 bg-white/90 backdrop-blur-sm rounded-lg px-4 py-2 shadow-md">
                      <p className="text-primary font-medium text-base lg:text-lg xl:text-xl">
                        {introSection.imageTag}
                      </p>
                    </div>
                  )}
              ...
              >
                {introSection?.heading && (
                  <h2
                    className={`text-2xl md:text-3xl lg:text-4xl font-heading font-bold text-primary mb-6 ${!introSection?.imageUrl ? "text-center" : ""}`}
                  >
                    {introSection.heading}
                  </h2>
                )}
                {introSection?.content && (
                  <div className="text-secondary text-base md:text-lg lg:text-xl leading-relaxed">
                    {introSection.content
                      .split("\n\n")
                      .map((paragraph, index) =>
                        paragraph.trim() ? (
      ...
      {locationId && (
        <LocationFeaturedPolicies locationId={locationId} locationSlug={slug} />
      )}
      ...
      {(() => {
        ...
        const gradientDirection =
          GRADIENT_MAP[ctaStyles?.gradient?.direction || "to-r"] || "to right";
        const gradientStart =
          ctaStyles?.gradient?.startColor || "var(--color-primary)";
        const gradientEnd =
          ctaStyles?.gradient?.endColor || "var(--divider-color)";
        ...
        const cardBorderColor =
          ctaStyles?.card?.borderColor || "rgba(255, 255, 255, 0.2)";
        ...
        const iconBgColor =
          ctaStyles?.iconContainer?.backgroundColor || "#ffffff";
        const iconBgOpacity = ctaStyles?.iconContainer?.backgroundOpacity ?? 50;
        ...
        const buttonTextColor =
          ctaStyles?.button?.textColor || "var(--color-primary)";
        ...
        return (
          <section
            className="py-16 px-4 text-primary-foreground relative"
            style={sectionStyle}
          >
            ...
            <div className="container mx-auto max-w-6xl text-center relative z-10">
              ...
              >
                Contact us today to learn how we can help protect what matters
                most.
              </p>
              ...
              <div className="grid grid-cols-1 max-w-md mx-auto">
                ...
                >
                  ...
                  >
                    <div
                      className="rounded-full p-4 inline-flex mb-4"
                    ...
                    <p
                      className="mb-5"
                      style={{ color: bodyColor, opacity: 0.8 }}
                    >
                      {city}, {state}
                    </p>
                    <span
