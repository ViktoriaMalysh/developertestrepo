...
export default function FAQItems({ items }) {
  ...
  const [helpfulFeedback, setHelpfulFeedback] = useState<
    Record<string, Record<number, "helpful" | "not-helpful" | null>>
  >({});
    ...
    <div className="space-y-12">
      {items.map((policy) => (
        <div
          key={policy.id}
          id={policy.id}
          className="max-w-3xl mx-auto bg-card-bg rounded-xl shadow-md overflow-hidden border border-[var(--divider-color)]"
        >
                  ...
                  <div className="p-4 bg-white text-theme-body leading-relaxed text-md">
                    ...
                    <div className="mt-4 flex items-center space-x-4 pt-2 border-t border-secondary/20">
                      ...
                      <button
                        ...
                        className={`inline-flex items-center space-x-1 p-1 rounded-md ${
