...
export default async function TeamMembers(
  {
    locationId,
    basePath = "/our-team",
  }: TeamMembersProps = {} as TeamMembersProps
) {
  // If no locationId provided, use primary location
  const resolvedLocationId =
    locationId ?? (await getClientPrimaryLocation())?.id;
  const [teamMembers, clientData, websiteData, businessInfo] =
    await Promise.all([
  ...
  const ldJsonSchema = {
    ...
    description:
      ...
      `Meet the dedicated insurance professionals at ${agencyName}.`,
    url: pageUrl,
    mainEntity: {
  ...
  return (
    <>
      <div className="container mx-auto px-4 max-w-screen-xl">
        ...
        {teamMembers?.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mx-auto max-w-5xl">
            {teamMembers.map((member, index) => (
              ...
              >
                <div className="bg-white shadow-md overflow-hidden border border-[var(--divider-color)] rounded-lg hover:shadow-lg transition-all duration-300 h-full flex flex-col">
        ...
        {/* Team Values Section */}
        <div className="mt-16 mb-10 bg-white rounded-xl p-8 shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-theme-body">
                Our experienced team provides knowledgeable advice for informed
                decisions.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-theme-body">
                We&apos;re here for you with responsive support when you need us
                most.
              </p>
            </div>
          </div>
        ...
        {/* Call to Action */}
        <div className="mt-12 text-center bg-white p-8 rounded-2xl shadow-md">
          <h3 className="text-2xl font-heading font-bold text-primary mb-4">
            Ready to Work with Our Team?
          </h3>
          <p className="text-theme-body mb-6 max-w-2xl mx-auto">
            Contact our team of dedicated insurance professionals today for
