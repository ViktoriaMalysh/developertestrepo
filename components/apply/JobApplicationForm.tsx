...
export default function JobApplicationForm({
  ...
  const renderField = (field: FormField) => {
    const commonClasses =
      "w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-secondary";
              ...
              >
                <div className="flex flex-col items-center justify-center pt-5 pb-6">
                  ...
                  <p className="text-xs text-gray-500">
                    ...
                    {field.maxSize
                      ? ` (MAX. ${(field.maxSize / 1024 / 1024).toFixed(0)}MB)`
                      : ""}
                  </p>
                </div>
                <input
  ...
  const shouldBeFullWidth = (field: FormField) => {
    return (
      field.type === "textarea" ||
      field.type === "file" ||
      field.id === "linkedin_url" ||
      field.id === "cover_letter"
    );
  };

  return (
    <div className="bg-white p-8 rounded-lg shadow-md border border-[var(--divider-color)]">
          ...
          {formFields.map((field) => {
            ...
            return (
              ...
              >
                <label
                  htmlFor={field.id}
                  className="block text-theme-body font-medium mb-2"
                >
                  {field.label}{" "}
