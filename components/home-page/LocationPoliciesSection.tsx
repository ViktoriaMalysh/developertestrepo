...
const LocationPoliciesSection = async () => {
  ...
  const sectionStyle = {
    backgroundColor: settings.section_bg_color || "#eae0d5",
  };
  const badgeStyle = {
    backgroundColor: settings.badge_bg_color || "var(--divider-color)",
    color: settings.badge_text_color || "#ffffff",
  };
  const headingStyle = {
    color: settings.heading_color || "var(--loc-heading)",
  };
  const subheadingStyle = {
    color: settings.subheading_color || "var(--color-secondary)",
  };
  const cardStyle = {
    backgroundColor: settings.card_bg_color || "var(--loc-card-bg)",
    borderColor: settings.card_border_color || "var(--divider-color)",
  };
  const cardHeadingStyle = {
    color: settings.card_heading_color || "var(--color-primary)",
  };
  const cardBodyStyle = {
    color: settings.card_body_color || "var(--loc-card-body)",
  };
  const accentLineStyle = {
    backgroundColor: settings.accent_line_color || "var(--color-primary)",
  };
  const buttonStyle = {
  ...
  const linkStyle = {
    color: settings.link_color || "var(--color-primary)",
  };
  ...
  if (multiLocation) {
    ...
    const lgGridCols =
      locationCount === 1
        ...
        : locationCount === 2
          ? "lg:grid-cols-2"
          : locationCount === 4 || locationCount === 5
            ? "lg:grid-cols-4"
            : "lg:grid-cols-3";
      ...
      <section className="py-16 relative" style={sectionStyle}>
        ...
        <div className="container mx-auto px-4 max-w-screen-xl">
          <div className="text-center mb-12 animation-fade-up">
            ...
            <h2
              className="text-3xl md:text-4xl font-heading font-bold mb-6 relative"
              style={headingStyle}
            >
              Find Coverage Near You
              <div
                className="h-1 w-24 rounded mx-auto mt-3 opacity-60"
          ...
          <div
            className={`grid grid-cols-1 md:grid-cols-2 ${lgGridCols} gap-6 justify-items-center ${gridContainerWidth}`}
          >
            {locations.map((location) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className="h-1 w-16 rounded mx-auto mb-4 opacity-60"
                    style={accentLineStyle}
                  ></div>
                  <p
                    className="mb-6 text-center flex-grow"
                    style={cardBodyStyle}
                  >
        ...
        <div className="container mx-auto px-4 max-w-screen-xl">
          <div className="text-center mb-12 animation-fade-up">
            ...
            <p
              ...
              style={subheadingStyle}
            >
              Explore our comprehensive insurance coverage options designed to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {policyPages.map((policy) => (
              ...
              >
                ...
                >
                  <h3
                    className="text-xl font-heading font-bold mb-3 text-center"
                    style={cardHeadingStyle}
                  >
                    {policy.title}
                  </h3>
