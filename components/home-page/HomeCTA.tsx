...
const HomeCTA = async () => {
  ...
  const gradientStart = styles?.gradient?.startColor || "var(--color-primary)";
  const gradientEnd = styles?.gradient?.endColor || "var(--divider-color)";
  ...
  const cardBorderColor =
    styles?.card?.borderColor || "rgba(255, 255, 255, 0.2)";
  ...
  const iconBgOpacity = styles?.iconContainer?.backgroundOpacity ?? 50;
  ...
  return (
    <section
      className="py-16 text-primary-foreground relative"
      style={sectionStyle}
    >
