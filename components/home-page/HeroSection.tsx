...
const HeroSection = async ({ locationId }: { locationId?: string | null }) => {
  ...
  return (
    ...
    >
      ...
      {heroContent?.background_media_type === "video" &&
      heroContent?.background_video?.url ? (
        ...
        <div className="w-full max-w-5xl mx-auto text-center animate-fade-in">
          <h1 className="mb-4 sm:mb-6">
            <span
              ...
              style={{
                color: heroContent?.title?.color || "var(--color-primary)",
              }}
            >
          ...
          <p className="mt-6 text-base sm:text-lg md:text-xl px-4 py-2 bg-white/60 backdrop-blur-sm rounded-lg shadow-sm max-w-xl mx-auto text-[#64748b]">
            {/* text-theme-body"> */}
